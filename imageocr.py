...
def get_data_one_ocr(page, reader):
    ...
    if any("driver" in s.lower() or "first" in s.lower() or "name" in s.lower()  or "last" in s.lower() or "sex" in s.lower() or "26." in s.lower() or "26 " in s.lower() for s in data_ocr):
        for i in data_ocr:
            if "driver" in i.lower() or "first" in i.lower() or "name" in i.lower() or "last" in i.lower() or "sex" in i.lower() or "26." in i.lower() or "26 " in i.lower() and SequenceMatcher(None, First_name, i).ratio() > 0.5:
        ...
        name = "--"
    if any("number" in s.lower() or "numb" in s.lower() or "street" in s.lower() or "stroot" in s.lower() or "ber" in s.lower() or "27." in s or "27 " in s for s in data_ocr):
        for i in data_ocr:
            if "number" in i.lower() or "numb" in i.lower() or "street" in i.lower() or "stroot" in i.lower() or "ber" in i.lower() or "27." in i or "27 " in i and SequenceMatcher(None, First_street, i).ratio() > 0.5:
        ...
        street = "--"
    if any("city" in s.lower() or "state" in s.lower() or "oty" in s.lower() or "chy" in s.lower() or "otv" in s.lower() or "ohv" in s.lower() or " statc" in s.lower() or " stare" in s.lower() or " stale" in s.lower() or "104" in s or "zip" in s.lower() or "cily" in s.lower() or "28." in s or "28 " in s for s in data_ocr):
        for i in data_ocr:
            if "city" in i.lower() or "state" in i.lower() or "oty" in i.lower() or "chy" in i.lower() or "otv" in i.lower() or "ohv" in i.lower() or " statc" in i.lower() or " stare" in i.lower() or "stale" in i.lower() or "104" in i or "zip" in i.lower() or "cily" in i.lower() or "28." in i or "28 " in i and SequenceMatcher(None, First_city, i).ratio() > 0.5:
        ...
        city = "--"
    if any("eye" in s.lower() or "eve" in s.lower() or "class" in s.lower() or "30 " in s or "30." in s for s in data_ocr):
        for i in data_ocr:
            if "eye" in i.lower() or "eve" in i.lower() or "class" in i.lower() or "30 " in i or "30." in i and SequenceMatcher(None, First_eyes, i).ratio() > 0.5:
...
def get_data_two_ocr(page, reader):
    ...
    if any("driver" in s.lower() or "first" in s.lower() or "name" in s.lower()  or "last" in s.lower() or "sex" in s.lower() or "56." in s.lower() or "56 " in s.lower() for s in data_ocr):
        for i in data_ocr:
            if "driver" in i.lower() or "first" in i.lower() or "name" in i.lower() or "last" in i.lower() or "sex" in i.lower() or "56." in i.lower() or "56 " in i.lower() and SequenceMatcher(None, Second_name, i).ratio() > 0.5:
                name_index = data_ocr.index(i)
                break
            else:
                continue
        ...
        name = "--"
    if any("number" in s.lower() or "numb" in s.lower() or "street" in s.lower() or "stroot" in s.lower() or "ber" in s.lower() or "57." in s or "57 " in s for s in data_ocr):
        for i in data_ocr:
            if "number" in i.lower() or "numb" in i.lower() or "street" in i.lower() or "stroot" in i.lower() or "ber" in i.lower() or "57." in i or "57 " in i and SequenceMatcher(None, Second_street, i).ratio() > 0.5:
                street_index = data_ocr.index(i)
                if street_index <= name_index: continue
                break
            else:
    ...
    if any("city" in s.lower() or "state" in s.lower() or "oty" in s.lower() or "chy" in s.lower() or "otv" in s.lower() or "ohv" in s.lower() or "zip" in s.lower() or "cily" in s.lower() or "58." in s or "58 " in s for s in data_ocr):
        ...
        city = "--"
    if any("eye" in s.lower() or "eve" in s.lower() or "class" in s.lower() or "60 " in s or "60." in s for s in data_ocr):
        for i in data_ocr:
            if "eye" in i.lower() or "eve" in i.lower() or "class" in i.lower() or "60 " in i or "60." in i and SequenceMatcher(None, Second_eyes, i).ratio() > 0.5:
                last_index = data_ocr.index(i)
                if last_index <= city_index: continue
                break
            else:
...
def get_value(page, reader):
    ...
    for string in data_ocr:
        string = string.replace('T1', '11').replace('t1', '11').replace('I1', '11').replace('T18', '118').replace('t18', '118').replace('T19', '119').replace('t19', '119').replace('11B', '118').replace('11E', '118').replace('11S', '119').replace('1186', '118b').replace('1196', '119b').replace('170', '120').replace('11E', '118').replace('11S', '119').replace('1186', '118b').replace('1196', '119b').replace('170', '120').replace('113', '118').replace('13a', '18a').replace('13b', '18b').replace('116', '118').replace('110', '118').replace('48a', '118a').replace('48b', '118b').replace('49a', '119a').replace('49b', '119b').replace('Ii', '11').replace('I', '1').replace('i', '1')
...
def remove_non_name(text):
    ...
    elif clean_string.endswith('LMK') or clean_string.endswith('LMi') or clean_string.endswith('Loo') or clean_string.endswith('MHz'):
        clean_string = clean_string[:-3]
    elif clean_string.endswith('LMko'):
...
def check_city(text):
    text = text.replace(" NJj ", " NJ ").replace("NBWARR", "NEWARK").replace("NBWARK", "NEWARK").replace("NEWARR", "NEWARK")
